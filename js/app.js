...
// ==========================
// Ko'dini o'g'irlagan k*t
// ==========================

/* search start */

let form = document.querySelector('#search-form');
let searchInput = document.querySelector('#search-form .search-inp');
let reset = document.querySelector('#search-form .clear-btn');
...
reset.addEventListener('click', function(){
    ...
    city.innerHTML = `
    <div class="ai-bot__img-box">
        <img src="./img/robot.png" alt="Robot AI" class="ai-bot__img">
    </div>
    `
})
...
form.addEventListener('submit', function(e){
    ...
    if (search == "") {
        ...
        if (search == '404') {
            ...
            city.innerHTML = `
                <h2 class="cities__title-error">4<i class="fas fa-gear fa-spin"></i>4</h2>
                <p class="cities__text-error">Kechirasiz ushbu sahifa topilmadi</p>
                <p class="cities__text">** Hozirda ba'zadan Andijon, Buxoro, Farg'ona, Namangan, Samarqand, Toshkent shaharlari haqida malumot olishingiz mumkin. **</p>
            `
        } else if (search == "andijon") {
            cityWrap.classList.remove('cities-active')
            city.innerHTML = `
            ...
            `
        } else if (search == "farg'ona" || search == "fargona" || search.value == "fergana" || search.value == "ferghana") {
            cityWrap.classList.remove('cities-active')
            city.innerHTML = `
            ...
            `
        } else if (search == "samarqand" || search == "maroqand") {
            cityWrap.classList.remove('cities-active')
            city.innerHTML = `
            ...
            `
        } else if (search == "toshkent" || search == "tashkent") {
            cityWrap.classList.remove('cities-active')
            city.innerHTML = `
            ...
            cityWrap.classList.add('cities-active')
            city.innerHTML = `
                <h2 class="cities__title-error">5<i class="fas fa-gear fa-spin"></i>2</h2>
                <p class="cities__text-error">Kechirasiz hozirda bazada ushbu shaxar haqida ma'lumot mavjud emas.</p>
                <p class="cities__text">** Hozirda ba'zadan Andijon, Buxoro, Farg'ona, Namangan, Samarqand, Toshkent shaharlari haqida malumot olishingiz mumkin. **</p>
            `
        }
    }
